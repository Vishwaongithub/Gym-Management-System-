...
include('aside.php');
 ...
 <div class="content-wrapper">
    ...
    <?php    
      $res=mysqli_query($con,"SELECT * FROM gym_type");
      $a=0;
        ...
        <tr>
                   ...
                   <td style="text-align: center;"> 
                      <button type="button" class="btn  bg-gradient-info btn-sm">
                        <a href ="upd_gym_type.php?id='.$row[0].'"><i class="fa fa-edit" style="color:white"></i></a>
                      </button>
                    </td>

                     <td style="text-align: center;"> 
                      <button type="button"  class="btn  bg-gradient-warning btn-sm">
                        <a href ="del_gym_type.php?id='.$row[0].'"> <i class="fa fa-trash" style="color:white"></i>
                      </button>
                    </td>
